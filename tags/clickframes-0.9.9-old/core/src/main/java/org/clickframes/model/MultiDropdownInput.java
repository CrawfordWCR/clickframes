...
public class MultiDropdownInput extends SingleUserInput {
    public MultiDropdownInput(Appspec appspec, InputType inputType, AppspecElement parent) throws EntityNotFoundException,
            EntityPropertyNotFoundException {
        super(appspec, InputTypeEnum.MULTIPLE, inputType, parent);
    }
