...
public class RadioInput extends SingleUserInput {
    public RadioInput(Appspec appspec, InputType inputType, AppspecElement parent) throws EntityNotFoundException,
            EntityPropertyNotFoundException {
        super(appspec, InputTypeEnum.RADIO, inputType, parent);
    }
